...
import img1 from '../Comunidades/img/ten.jpg'
import Maps8 from '../mapas/maps8'
    ...
    <div className='body'>
      ...
      <div className='provincias'>
        <div className='box01'>
          ...
          <h2>odiseo es uno de los pubs mas emblemáticos de la zona sur del país con más de 30 años abierto al publico en general, pero más especificamente para el publico de estilos musicales urbanos, com reggaeton y demás estilos actuales. <br></br>cuenta con la presencia de un personals exquisito. <br></br>no dudes en venir a experimentar una noche llena de emociones y vivencias.<br></br>Siempre buscamos lo mejor para nuestros clientes, por eso te proporcionamos un numero de teléfono para cualquier tipo de consulta u objeción.<br></br><br></br>Estilos musicales pricipales: Reggaeton, electrónica y pachangueo<br></br><br></br>teléfono: 678254877</h2>
          </div>
        </div>
        </div>
